...
class ListViewTest(TestCase):
    ...
    def test_validation_errors_end_up_on_list_page(self):
        """test: validation errors end up on list page"""
        list_ = List.objects.create()
        response = self.client.post(
            f"/lists/{list_.id}/",
            data={'item_text': ''}
...
class NewListTest(TestCase):
    ...
    def test_validation_errors_are_sent_back_to_home_page_temp(self):
        """test: validation errors are sent back to home page temp"""
